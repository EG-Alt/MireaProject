    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("Добавить заметку в истории?")
                ...
                .setPositiveButton("Сохранить", (dialog, id) -> {
                    ...
                    com.mirea.altukhova.mireaproject.ui.notes.Cell cell = new com.mirea.altukhova.mireaproject.ui.notes.Cell();
                ...
                .setNeutralButton("Очистить истории",
                        (dialog, id) -> {
                            ...
                            AppData db = App.getInstance().getDatabase();
                            NoteDAO noteDAO = db.storyDao();
                            List<com.mirea.altukhova.mireaproject.ui.notes.Cell> cells = noteDAO.getAll();
                            for (com.mirea.altukhova.mireaproject.ui.notes.Cell cell : cells) {
                                noteDAO.delete(cell);
                            }
                            dialog.cancel();
                        });
