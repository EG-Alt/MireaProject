...
public class AdapterCell extends RecyclerView.Adapter<com.mirea.altukhova.mireaproject.ui.notes.AdapterCell.StoryHolder> {
    List<com.mirea.altukhova.mireaproject.ui.notes.Cell> notes;

    public AdapterCell(List<com.mirea.altukhova.mireaproject.ui.notes.Cell> notes) {
        this.notes = notes;
    }
    ...
    class StoryHolder extends RecyclerView.ViewHolder {
        ...
        void bind(int listIndex) {
            com.mirea.altukhova.mireaproject.ui.notes.Cell cell = notes.get(listIndex);
